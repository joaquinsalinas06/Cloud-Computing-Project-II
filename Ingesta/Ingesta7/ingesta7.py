...
archivo_csv_album = 'stage-prod-album.csv'
archivo_csv_song = 'stage-prod-album-songs.csv'
glue_database = 'stage-prod'  
glue_table_name_album = 'stage-prod-album'
glue_table_name_song = 'stage-prod-album-songs'
