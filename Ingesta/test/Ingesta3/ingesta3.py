...
archivo_csv_playlist = 'stage-test-playlist.csv'  
archivo_csv_playlist_song = 'stage-test-playlist-song.csv'  
glue_database = 'stage-test'  
glue_table_playlist = 'stage-test-playlist'  
glue_table_playlist_song = 'stage-test-playlist-song'  # Tabla en Glue para canciones relacionadas con las playlists
