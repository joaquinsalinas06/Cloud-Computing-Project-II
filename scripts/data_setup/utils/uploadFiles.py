...
tablas_archivos = {
    ...
    "test-t_album": ["albumsV1.json", "albumsV2.json", "albumsData.json"], #// Uncomment this line to include the albumsData.json file for Data Science

    #"dev-t_artist": ["artistsV1.json", "artistsV2.json"],
    "test-t_artist": ["artistsV1.json", "artistsV2.json", "artistsData.json"], #// Uncomment this line to include the artistsData.json file for Data Science

    "test-t_post": ["posts.json"],

    #"dev-t_song": ["songsV1.json", "songsV2.json"],
    "test-t_song": ["songsV1.json", "songsV2.json", "songsData.json"], #// Uncomment this line to include the songsData.json file for Data Science
