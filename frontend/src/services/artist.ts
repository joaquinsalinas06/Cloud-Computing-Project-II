...
const ARTIST_URL =
	"https://3rof6mhp8i.execute-api.us-east-1.amazonaws.com/dev/artist";
...
export const fetchArtists = async (
	...
	const url = `${ARTIST_URL}/all?provider_id=${provider_id}&limit=${limit}&exclusiveStartKey=${encodeURIComponent(
		exclusiveStartKey || ""
	)}`;
